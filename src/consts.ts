...
export const OPEN_GRAPH = {
  image: {
    ...
    alt: 'JDK Outstanding Technologies Logo '
  },
...
export const SIDEBAR: Sidebar = {
  en: {
    ...
    'Local Environment': [
      ...
      {
        text: 'How to install VSCode on Windows 11',
        link: 'en/install-vscode-windows-11'
      },
      {
        text: 'How to install GIT on Windows 11',
        link: 'en/install-git-windows-11'
      },
      {
        text: 'How to install nodejs on Windows 11',
